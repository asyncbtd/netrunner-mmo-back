insert into reference_schema.ref_countries (country_name, country_official_name, country_iso2, country_iso3, country_code)
values ('Afghanistan', 'Afghanistan', 'AF', 'AFG', '004'),
       ('Aland Islands', 'Aland Islands', 'AX', 'ALA', '248'),
       ...
       ('Bosnia and Herzegovina', 'Bosnia and Herzegovina', 'BA', 'BIH', '070'),
       ...
       ('Brunei Darussalam', 'Brunei Darussalam', 'BN', 'BRN', '096'),
       ...
       ('Falkland Islands', 'Falkland Islands', 'FK', 'FLK', '238'),
       ...
       ('Kiribati', 'Kiribati', 'KI', 'KIR', '294'),
       ('Korea (Democratic Peoples Republic)', 'Korea (Democratic Peoples Republic)', 'KP', 'PRK', '408'),
       ('Korea (Republic)', 'Korea (Republic)', 'KR', 'KOR', '410'),
       ...
       ('Mauritania', 'Mauritania', 'MR', 'MRT', '484'),
       ...
       ('Palestine, State', 'Palestine, State', 'PS', 'PSE', '275'),
       ...
       ('Saint Barthelemy', 'Barthelemy', 'BL', 'BLM', '652'),
       ...
       ('Sint Maarten', 'Sint Maarten', 'SX', 'SXM', '534'),
       ...
       ('Tanzania United Republic', 'Tanzania United Republic', 'TZ', 'TZA', '834'),
       ...
       ('United States Minor Outlying Islands', 'United States Minor Outlying Islands', 'UM', 'UNI', '581'),
       ...
       ('Virgin Islands (British)', 'Virgin Islands (British)', 'VG', 'VGB', '092'),
       ('Virgin Islands (U.S.)', 'Virgin Islands (U.S.)', 'VI', 'VER', '850'),
       ('Wallis and Futuna', 'Customize Toolbar', 'WF', 'WLF', '876'),
       ('Western Sahara', 'Western Sahara', 'EH', 'ESH', '732'),
       ('Yemen', 'Yemen', 'YE', 'YEM', '887'),
       ('Zambia', 'Zambia', 'ZM', 'ZMB', '894'),
       ('Zimbabwe', 'Zimbabwe', 'ZW', 'ZWE', '716');

insert into reference_schema.ref_languages (language_name, language_official_name, language_iso, language_code)
values ('Russian', 'Russian', 'RU', '570'),
       ('English', 'English', 'EN', '045');
